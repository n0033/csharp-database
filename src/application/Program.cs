        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (var db = new BankAccountsDatabase(dbFile))
                {
                    ...
                    Console.WriteLine("Found account by id: " + db.Find(Guid.Parse("8872d8ba-e470-440d-aa9b-071822e8053f"))!.ToString());
                    Console.WriteLine("Arturo deleted: " + db.Delete(Guid.Parse("59ee9033-4ec5-40e0-91a7-6c9ecb6e0465")));

                    Console.WriteLine("Adamo pesel and balance update...");
                    BankAccountModel adamo;
                    adamo = db.Find(Guid.Parse("8872d8ba-e470-440d-aa9b-071822e8053f"))!;
                    adamo.Balance = 20;
                    adamo.Pesel = "666";
                    Console.WriteLine("Adamo updated: " + db.Update(adamo));

                    // Find all accounts that belong to a person named adam who is 25 years old
